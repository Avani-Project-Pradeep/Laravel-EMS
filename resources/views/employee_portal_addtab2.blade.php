...
<div class="tab-content">
    ...
    <input type="text" name="employee_id" value={{session()->$professional_details('employee_id')}} >
    <span style="color:red; font-size:12px;">
     ...
     <input type="text" name="designation" value="{{session()->$professional_details('designation')}}">
